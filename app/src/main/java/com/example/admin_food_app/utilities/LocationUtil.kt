...
class LocationUtil {
    ...
    // Convert an address to LatLng using Google Geocoding API
    ...
    // Fetch order details (restaurantLocation and userLocation) from Firebase
    ...
    // Fetch all couriers from Firebase and find the nearest one
    ...
    // Update the status of a courier in Firebase
